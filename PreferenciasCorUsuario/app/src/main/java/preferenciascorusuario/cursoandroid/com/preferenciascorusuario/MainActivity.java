...
public class MainActivity extends Activity {
    ...
    private static final String ARQUIVO_PREFERENCIA = "ArqPreferncia";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sharedPreferences.contains("corEscolhida")){
            String corRecuperada = sharedPreferences.getString("corEscolhida", "Laranja"); // Laranja padrão, caso não escolher cor
